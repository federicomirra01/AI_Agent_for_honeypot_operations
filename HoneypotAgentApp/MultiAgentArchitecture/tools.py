...
async def add_allow_rule(source_ip: str, dest_ip: str) -> Dict[str, Any]:
    """
    ...
    async with firewall_lock:
        response = await _add_allow_rule(source_ip, dest_ip)
    
    return response

async def add_block_rule(source_ip: str, dest_ip: str) -> Dict[str, Any]:
    """
    ...
    """
    async with firewall_lock:
        response = await _add_block_rule(source_ip, dest_ip)
    return response 
...
async def _add_allow_rule(source_ip: str, dest_ip: str) -> Dict[str, Any]:
    """
    Add firewall allow rule
    ...
    rule_description = f"ALLOW {source_ip} -> {dest_ip})"
...
async def _add_block_rule(source_ip: str, dest_ip: str) -> Dict[str, Any]:
    """
    Add firewall block rule
    ...
    rule_description = f"BLOCK {source_ip} -> {dest_ip})"
